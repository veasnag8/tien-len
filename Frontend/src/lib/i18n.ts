...
const dictionaries = {
  en: {
    ...
    rule2: 'Allowed: single, pair, sam (triple), raang (straight of 3+ up to A), ការ៉េ (four of a kind), consecutive pairs. No 2s in straights.',
  ...
  km: {
    ...
    rule2: 'អាចលេង៖ មួយសន្លឹក · គូ · សាម (ឧ. សាម៩) · រាង (ពី ៣ សន្លឹកឡើងទៅ រហូតដល់ A ឧ. ៤-៥-៦-…-A) · ការ៉េ · គូរៀង។ រាងមិនមាន២។',
